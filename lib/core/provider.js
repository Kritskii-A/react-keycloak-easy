    ...
    return /** @class */ (function (_super) {
        ...
        function KeycloakProvider() {
            ...
            _this.updateState = function (event) { return function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, authClient, onEvent, onTokens, isLoadingCheck, tokenExchangeParams, _b, prevInitialized, prevAuthenticated, prevLoading, isLoading, isAuthenticated, idToken, refreshToken, token, newToken, b64DecodeUnicode_1, base64UrlDecode_1, decodeToken, error_1;
                    ...
                    switch (_c.label) {
                        ...
                        case 2:
                            ...
                            if (onTokens) {
                                ...
                                b64DecodeUnicode_1 = function (input) {
                                    return decodeURIComponent(atob(input).replace(/(.)/g, function (_, p) {
                                ...
                                base64UrlDecode_1 = function (input) {
                                    ...
                                    try {
                                        return b64DecodeUnicode_1(output);
                                    }
                                    catch (error) {
                                        return atob(output);
                                    }
                                ...
                                decodeToken = function (token) {
                                    var _a = token.split("."), _ = _a[0], payload = _a[1];
                                    if (typeof payload !== "string") {
                                        throw new Error("Unable to decode token, payload not found.");
                                    }
                                    var decoded;
                                    try {
                                        decoded = base64UrlDecode_1(payload);
                                    }
                                    catch (error) {
